...
class SongBookUser extends Authenticatable implements JWTSubject
{
    use HasFactory, Notifiable,SoftDeletes;
    protected $table = 'song_book_users';
    protected $fillable = ['firstname','lastname','email','telephone','password','status','amount','device_id','device_name'];
