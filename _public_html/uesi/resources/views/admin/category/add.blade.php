...
@php @endphp
    ...
    <div class="container-fluid">
      ...
      <form method="post" class="row" action="{{ route('category.store') }}" enctype="multipart/form-data" autocomplete="off">
          @csrf
          @method('post')
                      ...
                      <div class="tab-pane @if($key == 0) active @endif" id="language{{$language->id}}">
                        ...
                        <div class="pl-lg-4 row">
                            ...
                            <div class="col-md-6 form-group{{ $errors->has('multilanguage.*.name') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="multilanguage[{{$language->id}}][name]" id="input-name" class="form-control form-control-alternative{{ $errors->has('multilanguage.*.name') ? ' is-invalid' : '' }}" placeholder="{{ __('Enter Name') }}" value="{{ old('name', '') }}" autofocus>
                            ...
                            <div class="col-md-6 form-group{{ $errors->has('meta_title') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="multilanguage[{{$language->id}}][meta_title]" id="meta_title" class="form-control form-control-alternative{{ $errors->has('meta_title') ? ' is-invalid' : '' }}" placeholder="{{ __('Meta Title') }}" value="{{ old('meta_title', '') }}" autofocus>
                            ...
                            <div class="col-md-6 form-group{{ $errors->has('meta_keyword') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="multilanguage[{{$language->id}}][meta_keyword]" id="meta_keyword" class="form-control form-control-alternative{{ $errors->has('meta_keyword') ? ' is-invalid' : '' }}" placeholder="{{ __('Meta Keyword') }}" value="{{ old('meta_keyword', '') }}" autofocus>
                            ...
                            <div class="col-md-6 form-group{{ $errors->has('meta_description') ? ' has-danger' : '' }}">
                                ...
                                <textarea name="multilanguage[{{$language->id}}][meta_description]" id="meta_description" class="form-control form-control-alternative{{ $errors->has('meta_description') ? ' is-invalid' : '' }}" placeholder="{{ __('Meta Description') }}" value="{{ old('meta_description', '') }}" rows="3"></textarea>
