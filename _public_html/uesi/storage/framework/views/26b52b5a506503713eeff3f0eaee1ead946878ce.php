                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('role.store')); ?>"  autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4"><?php echo e(__('Add Role ')); ?></h6>
                            ...
                            <div class="pl-lg-4 row">
                                <div class="col-md-4 form-group<?php echo e($errors->has('name') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control form-control-alternative<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>"  value="<?php echo e(old('name', '')); ?>" autofocus>
                                    ...
                                    <?php $__currentLoopData = $val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-md-2 form-group">
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="permissions[]"  value="<?php echo e("$key.$key1"); ?>"> <?php echo e($val1); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/picklmsc/uesi.picklms.com/resources/views/admin/role/add.blade.php ENDPATH**/ ?>