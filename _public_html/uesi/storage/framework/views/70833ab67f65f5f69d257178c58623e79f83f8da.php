                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo e(route('country')); ?>">Country</a></li>
                                <li class="breadcrumb-item">List</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-6 col-5 text-right">
                        <a href="<?php echo e(route('country.add')); ?>" class="btn btn-lg btn-neutral fade-class"><i class="fas fa-plus fa-lg"></i> New</a>
          ...
          <div class="col">
              <div class="card">
                <div class="card-header border-0">
                    ...
                    <form action="<?php echo e(route('country')); ?>">
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <a href="<?php echo e(route('country')); ?>" class="btn btn-info"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </form>
                </div>
                                    ...
                                    <td class="">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="<?php echo e(route('country.edit',['id' => $value->id])); ?>">Edit</a>
                                                <a class="dropdown-item deleteData" type="button"  href="javascript:void(0)" data-url="<?php echo e(route('country.delete',['id' => $value->id])); ?>">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/picklmsc/uesi.picklms.com/resources/views/admin/country/index.blade.php ENDPATH**/ ?>