                      ...
                      <div class="col-md-4 form-group }}">
                        <form class="" action="<?php echo e(route('order.updateStatus',['id' => $order->id])); ?>" method="post">
                          ...
                          <div class="form-group mt-3">
                              <label for="order_track_id" class="control-label">Order Track Id*</label>
                              <input type="text" name="order_track_id" id="order_track_id" class="form-control" value="<?php echo e($order->order_track_id); ?>" required="false"></textarea>
                          </div>
                          <div class="form-group mt-3">
                              <label for="comment" class="control-label">Comment</label>
                              <textarea name="comment" rows="3"  id="comment" class="form-control" required="true"><?php echo e($order->order_status_id); ?></textarea>
                          </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u298273519/domains/vidhyarthigeethavali.com/public_html/uesi/resources/views/admin/order/view.blade.php ENDPATH**/ ?>