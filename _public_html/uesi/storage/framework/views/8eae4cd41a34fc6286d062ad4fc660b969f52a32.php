        ...
        <div class="table-responsive">
            <table class="table align-items-center table-flush" id="tbl">
                ...
                <tr class="tr_clone">
                    ...
                    <td class="budget"> <input type="number" min="1" name="product_image[sort_order_image][]" id="sort_order_image0" value="<?php echo e(old('sort_order_image', '')); ?>" class="form-control form-control-alternative<?php echo e($errors->has('sort_order_image') ? ' is-invalid' : ''); ?>"  autofocus></td>
                    <td>
...
<?php /**PATH /home/u298273519/domains/vidhyarthigeethavali.com/public_html/uesi/resources/views/admin/product/tabs/image.blade.php ENDPATH**/ ?>