<div class="tab-pane " id="tab-data">
  ...
  <div class="row">
    <div class="col-md-6 form-group<?php echo e($errors->has('model') ? ' has-danger' : ''); ?>">
        ...
        <input type="text" name="model" id="model" class="form-control form-control-alternative<?php echo e($errors->has('model') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Model')); ?>" value="<?php echo e(old('model', $product->model)); ?>" >
    ...
    <div class="col-md-6 form-group<?php echo e($errors->has('price') ? ' has-danger' : ''); ?>">
        ...
        <input type="number" name="price" id="price" class="form-control form-control-alternative<?php echo e($errors->has('price') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Price')); ?>" value="<?php echo e(old('price', $product->price)); ?>" >
  ...
  <div class="row">
    <div class="col-md-6 form-group<?php echo e($errors->has('quantity') ? ' has-danger' : ''); ?>">
        ...
        <input type="text" name="quantity" id="quantity" value="<?php echo e(old('quantity', $product->quantity)); ?>" class="form-control form-control-alternative<?php echo e($errors->has('quantity') ? ' is-invalid' : ''); ?>" >
    ...
    <div class="col-md-6 form-group<?php echo e($errors->has('sku') ? ' has-danger' : ''); ?>">
        ...
        <input type="text" name="sku" id="sku" value="<?php echo e(old('sku', $product->sku)); ?>" class="form-control form-control-alternative<?php echo e($errors->has('sku') ? ' is-invalid' : ''); ?>" >
    ...
    <div class="col-md-6 form-group <?php echo e($errors->has('tax_rate_id') ? ' has-danger' : ''); ?>">
        ...
        <select class="form-control <?php echo e($errors->has('tax_rate_id') ? ' has-danger' : ''); ?>" name="tax_rate_id">
            ...
            <?php $__currentLoopData = $data['tax_rate']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($key); ?>"  <?php echo e($product->tax_rate_id == $key ? 'selected' : ''); ?>><?php echo e($value); ?></option>
        ...
        <div class="row">
            <div class="col-md-6 form-group<?php echo e($errors->has('length') ? ' has-danger' : ''); ?>">
                ...
                <input type="text" name="length" id="length" class="form-control form-control-alternative<?php echo e($errors->has('length') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Length')); ?>" value="<?php echo e(old('length', $product->length)); ?>" >
            ...
            <div class="col-md-6 form-group<?php echo e($errors->has('width') ? ' has-danger' : ''); ?>">
                ...
                <input type="text" name="width" id="width" class="form-control form-control-alternative<?php echo e($errors->has('width') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Width')); ?>" value="<?php echo e(old('width', $product->width)); ?>" >
          ...
          <div class="row">
            <div class="col-md-6 form-group<?php echo e($errors->has('height') ? ' has-danger' : ''); ?>">
                ...
                <input type="text" name="height" id="height" class="form-control form-control-alternative<?php echo e($errors->has('height') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Height')); ?>" value="<?php echo e(old('height', $product->height)); ?>" >
            ...
            <div class="col-md-6 form-group<?php echo e($errors->has('weight_class_id') ? ' has-danger' : ''); ?>">
                ...
                <select class="form-control" name="weight_class_id">
                    ...
                    <?php $__currentLoopData = $data['weight_class']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>" <?php echo e($product->weight_class_id == $key ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
      ...
      <div class="row">
        ...
        <div class="col-md-6 form-group<?php echo e($errors->has('weight') ? ' has-danger' : ''); ?>">
            ...
            <input type="text" name="weight" id="weight" class="form-control form-control-alternative<?php echo e($errors->has('weight') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Weight')); ?>" value="<?php echo e(old('weight', $product->weight)); ?>" >
        ...
        <div class="col-md-6  form-group<?php echo e($errors->has('date_available') ? ' has-danger' : ''); ?>">
            <label class="form-control-label" for="date_available"><?php echo e(__('AvaiLabel Date')); ?></label>
            <div class="input-group input-group-alternative">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="ni ni-calendar-grid-58"></i></span>
                </div>
                <input name="date_available" class="form-control datepicker <?php echo e($errors->has('date_available') ? ' is-invalid' : ''); ?>" placeholder="Select date" type="text" value="<?php echo e(old('date_available', $product->date_available)); ?>" autofocus  >
        ...
        <div class="col-md-6 form-group<?php echo e($errors->has('stock_status_id') ? ' has-danger' : ''); ?>">
            ...
            <select class="form-control" name="stock_status_id">
                ...
                <?php $__currentLoopData = $data['stock_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($key); ?>" <?php echo e($product->stock_status_id == $key ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        ...
        <div class="col-md-6 form-group<?php echo e($errors->has('status') ? ' has-danger' : ''); ?>">
            ...
            <select class="form-control" name="status">
                <?php $__currentLoopData = config('constant.status'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value=<?php echo e($key); ?> <?php echo e($product->status == $key ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
      ...
      <div class="row">
        <div class="col-md-6 form-group<?php echo e($errors->has('sort_order') ? ' has-danger' : ''); ?>">
            ...
            <input type="number" min="0" name="sort_order" id="sort_order" value="<?php echo e(old('sort_order', $product->sort_order)); ?>" class="form-control form-control-alternative<?php echo e($errors->has('sort_order') ? ' is-invalid' : ''); ?>" >
...
<?php /**PATH /home/u298273519/domains/vidhyarthigeethavali.com/public_html/uesi/resources/views/admin/product/tabs/edit_tabs/data.blade.php ENDPATH**/ ?>