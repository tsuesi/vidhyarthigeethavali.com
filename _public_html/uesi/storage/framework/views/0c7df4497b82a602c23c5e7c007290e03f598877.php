...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo e(route('featured-product')); ?>"> Featured Products</a></li>
    ...
    <div class="container-fluid">
        <div class="row  ">
            <div class="col">
                <div class="card">
                  <form method="post" id="data-form" action="<?php echo e(route('featured-product.store')); ?>" enctype="multipart/form-data" autocomplete="off">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('post'); ?>
                    <div class="col-md-10  mt-3 ml-8 form-group<?php echo e($errors->has('product_id') ? ' has-danger' : ''); ?>">
                      <label class="form-control-label" for="parent_id"><?php echo e(__('Add Product To Featured ')); ?></label>
                      <select class="form-control selectpicker " multiple data-live-search="true" name="product_id[]" >
                          <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value=<?php echo e($value->id); ?> <?php echo e(in_array($value->id,$pluckProducts) ? 'selected' : ''); ?>><?php echo e($value->productDescription->name); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                  </div>
                    <div class="text-center">
                        <button type="submit" class="btn btn-success btn-lg mb-3"><i class="fa fa-plus"></i> <?php echo e(__('Add Selected Products To Featured')); ?></button>
                    </div>
                  </form>
                </div>
              </div>
                        ...
                        <table class="table align-items-center table-flush">
                          ...
                          <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                              <tr>
                                <td>
                                  <?php if( $value->image): ?>
                                    <img src="<?php echo e(asset('/uploads/product').'/'. $value->image); ?>"  alt="<?php echo e($value->name); ?>"  class="img-thumbnail img-fluid" style=" width: 60px;height: 60px;">
                                  <?php else: ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/picklmsc/uesi.picklms.com/resources/views/admin/featuredproducts/index.blade.php ENDPATH**/ ?>