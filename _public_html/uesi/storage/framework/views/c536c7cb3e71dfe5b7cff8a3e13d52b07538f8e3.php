                        ...
                        <form action="<?php echo e(route('category')); ?>">
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <a href="<?php echo e(route('category')); ?>" class="btn btn-info"><i class="fas fa-sync-alt"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                  <td class="budget">
                                    <?php if($value->image): ?>
                                      <img src="<?php echo e(asset('/uploads/category').'/'.$value->image); ?>"  alt="<?php echo e($value->categoryDescription->name); ?>"  class="img-thumbnail img-fluid" style=" width: 60px;height: 60px;">
                                    <?php else: ?>
                                    ...
                                    <td class="budget"><?php echo e($value->categoryDescription->name); ?></td>
                                    <td class="budget"><?php echo e($value->parent_id == 0 ? 'Yes' : 'No'); ?></td>
                                    <td class="budget"><?php echo e($value->categoryDescription->meta_title); ?></td>
                                    ...
                                    <td class="">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="<?php echo e(route('category.edit',['id' => $value->category_id])); ?>">Edit</a>
                                                <a class="dropdown-item deleteData" type="button"  href="javascript:void(0)" data-url="<?php echo e(route('category.delete',['id' => $value->category_id])); ?>">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u298273519/domains/vidhyarthigeethavali.com/public_html/uesi/resources/views/admin/category/index.blade.php ENDPATH**/ ?>