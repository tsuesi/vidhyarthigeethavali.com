        ...
        <div class="row">
                <div class="col-xl-12 order-xl-1">
                    <div class="card bg-secondary shadow">
                        ...
                        <div class="card-body">
                          <form method="POST" action="<?php echo e(route('language.update',[ 'id' => $data->id ])); ?>" enctype="multipart/form-data" autocomplete="off">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('post'); ?>

                                <h6 class="heading-small text-muted mb-4"><?php echo e(__('Update Language ')); ?></h6>
                                ...
                                <div class="pl-lg-4 row">
                                    ...
                                    <div class="col-md-3 form-group<?php echo e($errors->has('language_name') ? ' has-danger' : ''); ?>">
                                        ...
                                        <input type="text" name="language_name" id="input-name" class="form-control form-control-alternative<?php echo e($errors->has('language_name') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Language Name')); ?>" value="<?php echo e(old('language_name',$data->language_name)); ?>" autofocus>
                                    ...
                                    <div class="col-md-2 form-group<?php echo e($errors->has('meta_title') ? ' has-danger' : ''); ?>">
                                        ...
                                        <input type="text" name="code" id="code" class="form-control form-control-alternative<?php echo e($errors->has('code') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Code (example:en-gb,ar)')); ?>" value="<?php echo e(old('code', $data->code)); ?>" autofocus>
                                    ...
                                    <div class="col-md-2 form-group<?php echo e($errors->has('status') ? ' has-danger' : ''); ?>">
                                        ...
                                        <select class="form-control" name="default_lang">
                                            <?php $__currentLoopData = config('constant.languages'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <option value=<?php echo e($key); ?> <?php echo e($key == $data->default_lang ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <?php if($errors->has('status')): ?>
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-md-3 form-group<?php echo e($errors->has('language_flag') ? ' has-danger' : ''); ?>">
                                      ...
                                      <?php endif; ?>
                                      <img alt="Image placeholder" class="my-2" width="100" height="60" src="<?php echo e(url(config('constant.file_path.language')."/$data->language_flag")); ?>">
                                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/picklmsc/uesi.picklms.com/resources/views/admin/language/edit.blade.php ENDPATH**/ ?>