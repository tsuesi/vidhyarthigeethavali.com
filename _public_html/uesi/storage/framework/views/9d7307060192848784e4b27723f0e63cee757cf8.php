<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
      ...
      <form method="POST" class="row" action="<?php echo e(route('category.update',[ 'id' => $data->category_id ])); ?>" enctype="multipart/form-data" autocomplete="off">
          <?php echo csrf_field(); ?>
            ...
            <div class="card mb-30">
                ...
                <div class="card-body">
                  <ul class="language nav nav-tabs  mb-5" id="languageTab" role="tablist">
                    ...
                    <?php $__currentLoopData = $data->categoryMultipleDescription; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <li class="nav-item">
                        <a class="nav-link  <?php if($key == 0): ?> text-primary font-weight-bold text-lg active <?php endif; ?>" id="language-tab<?php echo e($language->language_id); ?>" data-toggle="tab" href="#language<?php echo e($language->id); ?>" role="tab" aria-controls="<?php echo e($language->language_name); ?>" aria-selected="true"><?php echo e($language->language_name); ?></a>
                      </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </ul>

                  <div class="tab-content tab-validate" style="margin-top:20px;">
                      <?php $__currentLoopData = $data->categoryMultipleDescription; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$langdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <div class="tab-pane <?php if($key == 0): ?> active <?php endif; ?>" id="language<?php echo e($langdata->language_id); ?>">
                        <h4 class="ml-3 mb-3 text-info"> Enter data in <?php echo e($langdata->language_name); ?> </h4>
                        <div class="pl-lg-4 row">
                          <div class="col-md-6 form-group<?php echo e($errors->has('multilanguage.*.name') ? ' has-danger' : ''); ?>">
                              ...
                              <input type="text" name="multilanguage[<?php echo e($langdata->language_id); ?>][name]" id="input-name" class="form-control form-control-alternative<?php echo e($errors->has('multilanguage.*.name') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Name')); ?>" value="<?php echo e(old('name', $langdata->name)); ?>" autofocus>
                          ...
                          <div class="col-md-6 form-group<?php echo e($errors->has('meta_title') ? ' has-danger' : ''); ?>">
                              ...
                              <input type="text" name="multilanguage[<?php echo e($langdata->language_id); ?>][meta_title]" id="meta_title" class="form-control form-control-alternative<?php echo e($errors->has('meta_title') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Meta Title')); ?>" value="<?php echo e(old('meta_title', $langdata->meta_title)); ?>" autofocus>
                          ...
                          <div class="col-md-6 form-group<?php echo e($errors->has('meta_keyword') ? ' has-danger' : ''); ?>">
                              ...
                              <input type="text" name="multilanguage[<?php echo e($langdata->language_id); ?>][meta_keyword]" id="meta_keyword" class="form-control form-control-alternative<?php echo e($errors->has('meta_keyword') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Meta Keyword')); ?>" value="<?php echo e(old('meta_keyword', $langdata->meta_keyword)); ?>" autofocus>
                          ...
                          <div class="col-md-6 form-group<?php echo e($errors->has('meta_description') ? ' has-danger' : ''); ?>">
                              ...
                              <textarea name="multilanguage[<?php echo e($langdata->language_id); ?>][meta_description]" id="meta_description" class="form-control form-control-alternative<?php echo e($errors->has('meta_description') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Meta Description')); ?>" rows="3"><?php echo e(old('meta_description', $langdata->meta_description)); ?> </textarea>
                  ...
                  <div class="card-body">
                    <div class="pl-lg-4 row">
                      <div class="col-md-6 form-group<?php echo e($errors->has('parent_id') ? ' has-danger' : ''); ?>">
                          ...
                          <select class="form-control" name="parent_id">
                              ...
                              <?php $__currentLoopData = $parentCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($key); ?>"  <?php echo e($key == $data->parent_id ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </select>
                      ...
                      <div class="col-md-6 form-group<?php echo e($errors->has('sort_order') ? ' has-danger' : ''); ?>">
                          ...
                          <input type="number" min="1" name="sort_order" id="sort_order" value="<?php echo e(old('sort_order', $data->sort_order)); ?>" class="form-control form-control-alternative<?php echo e($errors->has('sort_order') ? ' is-invalid' : ''); ?>" autofocus>
                      ...
                      <div class="col-md-6 form-group<?php echo e($errors->has('image') ? ' has-danger' : ''); ?>">
                          ...
                          <input type="file" name="image" id="input-email" class="form-control form-control-alternative<?php echo e($errors->has('image') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('image', '')); ?>">
                          ...
                          <label class="form-control-label my-3" for="status"><?php echo e(__('Status')); ?></label>
                          <select class="form-control" name="status">
                              ...
                              <option value=<?php echo e($key); ?>  <?php echo e($key == $data->status ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </select>
                      ...
                      <div class="col-md-6 form-group">
                          <img alt="Image placeholder" width="200" height="200" src="<?php echo e(url(config('constant.file_path.category')."/$data->image")); ?>">
                      </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u298273519/domains/vidhyarthigeethavali.com/public_html/uesi/resources/views/admin/category/edit.blade.php ENDPATH**/ ?>