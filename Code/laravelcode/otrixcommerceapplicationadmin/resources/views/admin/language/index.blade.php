                        ...
                        <form action="{{ route('language') }}">
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <a href="{{ route('language') }}" class="btn btn-info"><i class="fas fa-sync-alt"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            @forelse($records as $key => $value)
                                ...
                                <tr>
                                    ...
                                    <td class="budget">{{ $value->language_name }}</td>
                                    ...
                                    <td class="">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="{{ route('language.edit',['id' => $value->id]) }}">Edit</a>
                                                <!-- <a class="dropdown-item deleteData" type="button"  href="javascript:void(0)" data-url="{{ route('language.delete',['id' => $value->id]) }}">Delete</a> -->
                                            </div>
                                        </div>
                                    </td>
                                </tr>
