<div class="tab-pane " id="tab-data">
  ...
  <div class="row">
    <div class="col-md-6 form-group{{ $errors->has('quantity') ? ' has-danger' : '' }}">
        ...
        <input type="number" min="1" name="quantity" id="quantity" value="{{ old('quantity', '') }}" class="form-control form-control-alternative{{ $errors->has('quantity') ? ' is-invalid' : '' }}" required>
    ...
    <div class="col-md-6 form-group{{ $errors->has('sku') ? ' has-danger' : '' }}">
        ...
        <input type="text" name="sku" id="sku" value="{{ old('sku', '') }}" class="form-control form-control-alternative{{ $errors->has('sku') ? ' is-invalid' : '' }}" >
        @if ($errors->has('sku'))
            <span class="invalid-feedback" role="alert">
