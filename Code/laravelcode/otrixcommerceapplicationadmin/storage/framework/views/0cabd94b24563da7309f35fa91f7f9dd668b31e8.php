            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        ...
                        <form action="<?php echo e(route('language')); ?>">
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <a href="<?php echo e(route('language')); ?>" class="btn btn-info"><i class="fas fa-sync-alt"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="parent_id">Code</th>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr>
                                    ...
                                    <td class="budget"><?php echo e($value->language_name); ?></td>
                                    <td class="budget"><?php echo e($value->code); ?></td>
                                    ...
                                    <td class="">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="<?php echo e(route('language.edit',['id' => $value->id])); ?>">Edit</a>
                                                <!-- <a class="dropdown-item deleteData" type="button"  href="javascript:void(0)" data-url="<?php echo e(route('language.delete',['id' => $value->id])); ?>">Delete</a> -->
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        $(document).on('click','.deleteData',function(){
            let alertMessage = "Are You Sure,Child Language will be delete If it Parent"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u554892978/domains/otrixcommerce.in/public_html/development/resources/views/admin/language/index.blade.php ENDPATH**/ ?>