          ...
          <div class="col">
              <div class="card">
                <div class="card-header border-0">
                    ...
                    <form action="<?php echo e(route('role')); ?>">
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <a href="<?php echo e(route('role')); ?>" class="btn btn-info"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </form>
                </div>
                                    ...
                                    <td class="">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="<?php echo e(route('role.edit',['id' => $value->id])); ?>">Edit</a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\php\www\otrixcommercelaravelapp\resources\views/admin/role/index.blade.php ENDPATH**/ ?>